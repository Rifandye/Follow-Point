...
export function Venue({
  ...
  const { nodes, materials } = useGLTF("/Venue.glb") as GLTF & {
        ...
        return (
          <>
            <group
              key={venue.id}
              name="Booth_13"
              position={boothPositions[index] as [number, number, number]}
            ...
            >
              ...
              />
              <Html position={iconPosition as [number, number, number]} center>
                <button
                  key={venue.name}
